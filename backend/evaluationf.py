"""
Evaluation Script: MiniLM vs Larger Embedding Models
Measures retrieval time, query complexity, and accuracy
"""
...
# Models to compare (both 384-d so they match a 384-index)
MODELS = {
    "MiniLM": "sentence-transformers/all-MiniLM-L6-v2",        # 384 dim, small
    "MiniLM_Large": "sentence-transformers/all-MiniLM-L12-v2", # 384 dim, larger
}

# ===========================
# TEST QUERIES (6 TYPES)
# ===========================
TEST_QUERIES = {
    "simple_fact": [
...
class ModelEvaluator:
    ...
    def evaluate_query_type(self, query_type: str, queries: List[str]) -> Dict:
        ...
        for query in queries:
            ...
            print(f"  ⏱️  {result['total_time']:.2f}ms - {query[:50]}...")
    ...
    def _calculate_complexity(self, queries: List[str]) -> float:
        ...
        return (avg_length + avg_words * 5) / 10  # Normalized complexity score
